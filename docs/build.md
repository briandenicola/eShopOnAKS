...
* :bulb: Setup Bridge-for-AKS to enable [Remote Debugging](https://learn.microsoft.com/en-us/visualstudio/bridge/parallel-services) and setup up a couple breakpoints in the eShop code to test the debugging feature.
